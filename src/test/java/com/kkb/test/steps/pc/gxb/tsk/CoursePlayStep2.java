 ...
 * @version 1.0
 */
public class CoursePlayStep2 extends LoginStep {
	/**
	 * slf4j
	 */
	 ...
	 * @throws Exception
	 */
	@Test(description = "2厦门海洋大学-查看视频播放 " , priority = 1)
	public void testVideoPaly() throws Exception {
		try {
			...
			//点击第一门课程
			String errorVideo = commonCourseLearnAct.clickCourse2();

			Reporter.log(errorVideo);
			logger.info("2厦门海洋大学-查看视频播放-测试用例执行结束！");
		
		} catch (Exception e) {
			logger.error("2厦门海洋大学-查看视频播放", e);
			throw new Exception("2厦门海洋大学-查看视频播放  >> "
					+ e.getMessage(), e);
		}
